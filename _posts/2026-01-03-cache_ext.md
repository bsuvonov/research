...
![](assets/img/cache_ext/fig10.png)

As shown in Figure 10, cache_ext’s application-informed policy achieves 70% higher throughput and 57% lower P99 latency for `GET`s, while `SCAN`s  experience an 18% throughput decrease.
